...
void kMeansClustering(std::vector<Point> &points) {
  ...
  // 4. For each iteration: Assign each point to its nearest centroid, then
  // recompute centroids as a mean of their assigned points.
...
int main() {
  ...
  // The point struct can be found in include/points.hpp and the csv reading
  // function can be found in include/fileops.hpp
  /*
